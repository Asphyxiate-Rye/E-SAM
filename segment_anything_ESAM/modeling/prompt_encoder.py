...
class PromptEncoder(nn.Module):
    ...
    def _get_batch_size(
        ...
        if points is not None:
            ...
            return image_embedding.shape[0]
        else:
            return 1
    ...
    def forward(
        ...
        sparse_embeddings = torch.empty((bs, 0, self.embed_dim), device=self._get_device())  # [16, 0, 256]
        ...
        if points is not None:
            ...
            sparse_embeddings = torch.cat([sparse_embeddings, point_embeddings], dim=1)   # [16, 2, 256]
