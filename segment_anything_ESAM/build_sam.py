...
def build_sam_vit_h(image_size, num_classes, args=None, checkpoint=None, pixel_mean=None, pixel_std=None):
    return _build_sam(
        args=args,
...
def build_sam_vit_l(image_size, num_classes, args=None, checkpoint=None, pixel_mean=None, pixel_std=None):
    return _build_sam(
        args=args,
...
def _build_sam_my(
    ...
    if checkpoint is not None:
        ...
        try:
            ...
            new_state_dict = load_from(sam, state_dict, image_size, vit_patch_size, encoder_global_attn_indexes, args=args)
            sam.load_state_dict(new_state_dict, strict=False)
        return sam, image_embedding_size


def load_from(sam, state_dict, image_size, vit_patch_size, encoder_global_attn_indexes, args=None):
...
def load_from_sammed2d(sam, state_dicts, image_size, vit_patch_size):
